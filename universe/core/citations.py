...
DEFAULT_SOURCES: tuple[Source, ...] = (
    Source("LEGISTAR_MIRROR",
           "jehiah/nyc_legislation — flat-file mirror of the NYC Council "
           "Legistar Web API",
           "Jehiah Czebotar, mirroring the New York City Council",
           "https://github.com/jehiah/nyc_legislation",
           tier="OFFICIAL_DERIVED",
           coverage="Introductions, resolutions and land use 1996-present, "
                    "with official summaries, full bill text, attachments, "
                    "action histories and sponsor lists; synced daily",
           notes="Generated by github.com/jehiah/legislator against the "
                 "Legistar Web API. Every record links back to the Council's "
                 "own LegislationDetail page, which is the primary source."),
    Source("OFFICE-WB",
           "FY27 Staten Island EIN Census and Reconciliation (56 worksheets)",
           "Office of Council Member Kamillah Hanks", None,
           tier="INSTITUTIONAL",
           coverage="District 49 and Staten Island FY2027 position, tied out "
                    "line by line against the printed Schedule C and §254 books",
           notes="The office's own reconciliation. Sheets carrying a passing "
                 "tie-check have been checked against the City's printed "
                 "book; sheets without one have not."),
    Source("OFFICE-D49", "District 49 FY2027 Full Breakdown",
           "Office of Council Member Kamillah Hanks", None,
           tier="INSTITUTIONAL",
           coverage="245 named items across 17 categories, $39,627,090",
           notes="Parse verified against the document's own stated totals."),
    Source("SI_DIRECTORY", "Staten Island government and services directory",
           "Office of Council Member Kamillah Hanks", None,
           tier="INSTITUTIONAL",
           coverage="45 contacts across federal, state, city and community "
                    "levels, each carrying the published page it was read from",
           notes="Nothing is guessed. Records marked unverified name a person "
                 "or number to confirm before use."),
    Source("OFFICE_CALENDAR", "District 49 office calendar",
           "Office of Council Member Kamillah Hanks", None,
           tier="INSTITUTIONAL",
           coverage="Hearings, community meetings and district events"),
