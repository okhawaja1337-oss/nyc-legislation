...
with sec_levels:
    t_gov, t_dir, t_elect = st.tabs(
        ["🏙️ State & Federal", "👤 Who governs NYC", "🗳️ Elections & terms"])
with sec_people:
    t_members, t_dossier, t_compare, t_net, t_map = st.tabs(
        ["👤 Members", "📕 Dossier", "⚖️ Compare", "🤝 Coalitions", "🗺️ District map"])
with sec_brief:
